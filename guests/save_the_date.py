...
def get_save_the_date_context(template_id):
    ...
    context['page_title'] = 'Kelsey and Dain - Save the Date!'
    context['preheader_text'] = (
        "The date that you've eagerly been waiting for is finally here. "
        "Kelsey and Dain are getting married! Save the date!"
    )
    return context
...
def send_save_the_date_email(context, recipients, test_only=False):
    ...
    template_text = "Save the date for Kelsey and Dain's wedding! July 2, 2016. Niagata-on-the-Lake, Ontario, Canada"
